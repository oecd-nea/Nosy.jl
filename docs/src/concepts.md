...
Start with the snapshot-building concepts when you are defining a system, then optimisation, finally concepts when you need results.

- [Time](concepts/time.md): temporal structure of the model
