...
examples, is available [here](https://oecd-nea.github.io/Nosy.jl/dev/).
...
## Related Model: Posy2.jl

[Posy2.jl](https://github.com/oecd-nea/Posy2.jl) is an open-source country- and
regional-level power systems model developed at the NEA on top of Nosy. Where
Nosy exposes the building blocks directly, Posy2.jl adds a higher-level layer
targeting energy analysts who are not optimization modelers.
